...
const FilterField = require('../../MapStore2/web/client/components/data/query/FilterField');
...
const AutocompleteField = require('../../MapStore2/web/client/components/data/query/AutocompleteFieldHOC');
const SwitchPanel = require('../../MapStore2/web/client/components/misc/switch/SwitchPanel');
const StringSelector = require('../../MapStore2/web/client/components/misc/StringSelector');
