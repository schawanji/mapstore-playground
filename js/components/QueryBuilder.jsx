...
const SliderGroupField = require('./SliderGroupField');
const GroupField = require('./GroupField');
const SpatialFilter = require('../../MapStore2/web/client/components/data/query/SpatialFilter');
const QueryToolbar = require('../../MapStore2/web/client/components/data/query/QueryToolbar');
const crossLayerFilterEnhancer = require('../../MapStore2/web/client/components/data/query/enhancers/crossLayerFilter');
const CrossLayerFilter = crossLayerFilterEnhancer(require('../../MapStore2/web/client/components/data/query/CrossLayerFilter'));
