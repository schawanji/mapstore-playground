...
const {storeCurrentFilter, discardCurrentFilter, applyFilter} = require('../../MapStore2/web/client/actions/layerFilter');


const {zoomToExtent} = require('../../MapStore2/web/client/actions/map');
const {toggleControl} = require('../../MapStore2/web/client/actions/controls');

const {groupsSelector, selectedLayerLoadingErrorSelector} = require('../../MapStore2/web/client/selectors/layers');
const {mapSelector} = require('../../MapStore2/web/client/selectors/map');
const {isDashboardAvailable} = require('../../MapStore2/web/client/selectors/dashboard');
const {
    crossLayerFilterSelector,
    availableCrossLayerFilterLayersSelector,
    storedFilterSelector,
    appliedFilterSelector
} = require('../../MapStore2/web/client/selectors/queryform');
...
const layerFilterEpics = require('../../MapStore2/web/client/epics/layerfilter');
...
const {initQueryPanel} = require('../../MapStore2/web/client/actions/wfsquery');
 ...
 * @class
 * @classdesc
 * FilterPanel allow to query a layer in different ways, using attributes of that layer, spatial filters
 * @name QueryPanel
 * @memberof plugins
 ...
 *    }
 */
const FilterPanel = connect(tocSelector, {
...
export default createPlugin("FilterPanel", {
    component:FilterPanel,
    reducers: {
        queryform: require('../../MapStore2/web/client/reducers/queryform'),
        query: require('../../MapStore2/web/client/reducers/query'),
        layerFilter: require('../../MapStore2/web/client/reducers/layerFilter')
    },
    epics: {featureTypeSelectedEpic, wfsQueryEpic, viewportSelectedEpic, redrawSpatialFilterEpic, ...autocompleteEpics, ...require('../../MapStore2/web/client/epics/queryform'), ...layerFilterEpics}
});
